...
const PayoutPage = () => {
  ...
  <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8 bg-slate-50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <h1 className="text-2xl font-bold text-slate-800">Payout Summary</h1>
        <div className="flex items-center gap-3">
          <div className="relative">
            <select className="appearance-none bg-white border border-slate-200 px-4 py-2 pr-10 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm">
          ...
          <button className="flex items-center gap-2 bg-blue-600 text-white px-5 py-2 rounded-lg text-sm font-bold hover:bg-blue-700 transition-all shadow-md shadow-blue-100">
      ...
      <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
        <div className="p-4 border-b border-slate-100 flex justify-between items-center">
          <h2 className="font-bold text-slate-700 text-base">Lead-wise Payout Report</h2>
          <span className="text-[10px] text-slate-400 uppercase font-bold">Filtered by: <span className="text-slate-600">All</span></span>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-100">
                {['Lead ID', 'Customer', 'Product', 'Lead Status', 'Commission', 'Bonus', 'Deduction', 'Final Payout', 'Remark', 'Payout Status', 'Payout Date'].map((header) => (
                  <th key={header} className="px-4 py-3 text-[10px] font-bold text-slate-500 uppercase whitespace-nowrap">
                    {header}
                  </th>
                ))}
              </tr>
            ...
            <tbody>
              <tr className="border-b border-slate-50 last:border-0">
                <td colSpan="11" className="px-6 py-10 text-center text-slate-400 text-sm italic">
      ...
      <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-6">
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-8 relative overflow-hidden">
          <div className="flex flex-col md:flex-row items-center justify-around gap-8 text-center">
            ...
            <div className="absolute top-4 left-6 flex items-center gap-2">
               ...
               <div className="text-left">
                 ...
                 <p className="text-[10px] text-blue-600">Earn 5% bonus on your team's sales performance</p>
               </div>
            </div>

            {/* Metrics */}
            <div className="mt-6 md:mt-15">
              <h4 className="text-3xl font-bold text-blue-700">0</h4>
              <p className="text-[11px] font-bold text-blue-400 uppercase tracking-wide mt-1">Team Members</p>
            </div>

            <div className="mt-4 md:mt-15">
              <h4 className="text-3xl font-bold text-blue-700">₹0</h4>
              <p className="text-[11px] font-bold text-blue-400 uppercase tracking-wide mt-1">Team Sales</p>
            </div>

            <div className="mt-4 md:mt-15">
              <h4 className="text-3xl font-bold text-blue-700">₹0</h4>
              <p className="text-[11px] font-bold text-blue-400 uppercase tracking-wide mt-1">Your Bonus (5%)</p>
            </div>
