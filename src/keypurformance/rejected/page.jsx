  ...
  return (
    ...
    <div className="p-8">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-xl font-semibold mb-4">Applications Declined</h2>
        <p className="text-gray-600 mb-4">View all rejected and declined applications.</p>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="border rounded-lg p-4 text-center">
            <p className="text-gray-600 text-sm mb-2">Total Rejected</p>
            <p className="text-3xl font-bold text-red-600">{stats.total}</p>
          </div>
          <div className="border rounded-lg p-4 text-center">
            <p className="text-gray-600 text-sm mb-2">Rejection Rate</p>
            <p className="text-3xl font-bold text-red-600">{stats.rate}%</p>
          </div>
          <div className="border rounded-lg p-4 text-center">
            <p className="text-gray-600 text-sm mb-2">This Month</p>
            <p className="text-3xl font-bold text-red-600">{stats.thisMonth}</p>
          </div>
        </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="text-left py-2 font-semibold">Rejection Date</th>
                </tr>
              </thead>
              <tbody>
                {applications.length > 0 ? (
                  ...
                  <tr className="border-b text-center text-gray-500">
                    <td colSpan="5" className="py-8">No rejected applications</td>
                  </tr>
                )}
              </tbody>
            </table>
